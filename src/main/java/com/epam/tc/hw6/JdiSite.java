...
public class JdiSite {
  ...
  public static void fillFormMetalsColors(MetalsColorsInfo metalsColorsInfo) {
    metalsColorsPage.fillFormMetalsColors(metalsColorsInfo);
  }
  ...
  public static void checkResultSection(MetalsColorsInfo metalsColorsInfo) {
    metalsColorsPage.checkResultSection(metalsColorsInfo);
  }
}